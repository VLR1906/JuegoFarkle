...
public class InterfazJuego extends JFrame {
    ...
    private void actualizarDados() {
        ...
        for (int i = 0; i < dados.size(); i++) {
            ...
            dadoBotones[i].setFont(new Font("Arial", Font.BOLD, 20));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            int numJugadores;
            do {
                String input = JOptionPane.showInputDialog(null, "¿Cuántos jugadores van a jugar? (2-6)", "Configuración", JOptionPane.QUESTION_MESSAGE);
